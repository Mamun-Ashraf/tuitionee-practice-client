...
const HouseTeacherLeaflet = () => {
    ...
    const { aboutStudent, offeredSalary, studentsRequirements, studentsInfo, medium, classes, subject, describe } = translations.leafletHouseTeacher;
            ...
            <form onSubmit={handleSubmit(handleLeaflet)}>
                <div className='md:flex gap-6'>
                    <div className='sm:w-11/12 md:w-1/2 mx-auto bg-base-100 shadow-md shadow-darkColor dark:shadow-grayBody p-5 rounded space-y-2 mb-6 md:mb-0'>
                        ...
                        <div>
                            <label htmlFor="" className='font-bold'>{offeredSalary} :</label>
                            <input type="number" name="" id="" className='p-2 block sm:ms-16 focus:outline-none text-darkColor rounded'></input>
                        </div>
                    ...
                    <div className='sm:w-11/12 md:w-1/2 mx-auto bg-base-100 shadow-md shadow-darkColor dark:shadow-grayBody p-5 rounded space-y-2'>
                        ...
                        <div>
                            <label htmlFor="" className='font-bold'>{studentsInfo} :</label>
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 ms-16'>
                                <select name="" id="" className='p-2 focus:outline-none text-darkColor rounded'>
