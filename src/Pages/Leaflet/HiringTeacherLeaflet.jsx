            ...
            <form onSubmit={handleSubmit(handleLeaflet)}>
                <div className='flex gap-12'>
                    <div className='w-1/2 bg-gray-50 p-5 rounded'>
                        <h2 className='text-center font-semibold text-lg text-yellow-500'>Demand of coaching center</h2>
                        <div className="form-control w-full">
                            ...
                            <input type="text" {...register("qualification",
                                ...
                                className="input input-bordered w-full pla" placeholder="Educational qualification of teacher." />
                            {errors.qualification && <p className='text-red-500' role="alert">{errors.qualification?.message}</p>}
                        </div>
                        <div className="form-control w-full">
                            <label className="label"><span className="label-text font-semibold">Post</span></label>
                            <input type="text" {...register("post",
                                {
                                    required: "Post is required"
                                })}
                                className="input input-bordered w-full pla" placeholder="Number of post." />
                            {errors.post && <p className='text-red-500' role="alert">{errors.post?.message}</p>}
                        </div>
                        <div className="form-control w-full">
                            <label className="label"><span className="label-text font-semibold">Subject/Subjects & Class</span></label>
                            <input type="text" {...register("subject",
                                {
                                    required: "Subject is required"
                                })}
                                className="input input-bordered w-full pla" placeholder="Subject/Subjects, has to teach." />
                        ...
                        <div className="form-control w-full">
                            ...
                            <input type="text" {...register("salary",
                                ...
                                className="input input-bordered w-full" placeholder="salary (tk/-) per class." />
                    ...
                    <div className='w-1/2 bg-gray-50 p-5 rounded'>
                        ...
                        <div className="form-control w-full">
                            ...
                            <input type="text" {...register("name",
                                ...
                                className="input input-bordered w-full" placeholder="Name of Director" />
                        ...
                        <div className="form-control w-full">
                            ...
                            <input type="email" {...register("email",
                                ...
                                className="input input-bordered w-full" placeholder="Email of Director" />
                        ...
                        <div className="form-control w-full mb-3">
                            ...
                            <input type="number" {...register("phoneNumber",
                                ...
                                className="input input-bordered w-full" placeholder="Phone number of Director" />
